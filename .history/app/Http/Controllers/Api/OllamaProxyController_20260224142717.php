...
class OllamaProxyController extends Controller
{
    ...
    public function chat(Request $request): JsonResponse|StreamedResponse
    {
        $data = $request->validate([
            ...
            'think' => ['nullable'], // boolean or string ("high", "medium", "low")
            'keep_alive' => ['nullable', 'string'],
            'logprobs' => ['nullable', 'boolean'],
            'top_logprobs' => ['nullable', 'integer'],
        ]);
    ...
    public function generate(Request $request): JsonResponse|StreamedResponse
    {
        $data = $request->validate([
            ...
            'images' => ['nullable', 'array'], // base64-encoded images
            'format' => ['nullable', 'string'],
    ...
    public function embed(Request $request): JsonResponse
    {
        ...
        return $this->proxyRequest('/api/embed', $data);
    }
    ...
    public function create(Request $request): JsonResponse|StreamedResponse
    {
        $data = $request->validate([
            ...
            'template' => ['nullable', 'string'],
            'license' => ['nullable'], // string or array
            'system' => ['nullable', 'string'],
            'parameters' => ['nullable', 'array'],
            'messages' => ['nullable', 'array'],
            'quantize' => ['nullable', 'string'],
            'stream' => ['nullable', 'boolean'],
        ]);
