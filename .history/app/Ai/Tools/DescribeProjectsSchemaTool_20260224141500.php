...
class DescribeProjectsSchemaTool implements Tool
{
    ...
    {
        return 'Discover construction project database schema and relations. ' .
            'Usage: Call with NO parameters {} to list all 52 available tables (work_details, work_histories, invoices, bills, materials, etc). ' .
            'Call with {"table": "table_name"} to get detailed column names, types, and Eloquent relationships for a specific table. ' .
            'Example: {"table": "work_histories"} returns columns and relations like workDetails(), invoice(), etc.';
    }
